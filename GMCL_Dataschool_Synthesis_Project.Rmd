...
# Introduction
Data School can teach and old dog new tricks.
...
ggplot is cool for data visualisation, but I am still learning new tricks to use it affectively.
...
I didn't use python in my Data school project, but I don't want to lose this skill, so I will have to make time use it. Also, machine learning is something I wish to continue investigating for larger datasets.
...
**Images from a file**
```{r, echo=FALSE, fig.cap="Core Sensing Platform", out.width = '50%' }
...
Tony, Seija, & I have already given a brief talk about Data Access Portal & Research Data Management Plan to Butler Lab to encourage awareness & discussion. We have also been asked to talk to our group about our Data School experience & project at some time in the future.

I was nervous about Data School and whether I would be able to handle it, but lessons were adjusted for everyone in the cohort, so everyone was able to learn. The teachers/tutors/mentors were very knowledgeable, helpful & wonderful. Data School was able to teach this old dog new tricks.
